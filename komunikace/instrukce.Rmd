...
V první řadě budete potřebovat přiměřeně čerstvé R a RStudio. V ideálním případě R 4.3.1 a RStudio 2023.06.0+421 "Mountain Hydrangea" - stačit bude jakákoliv čtyřková verze erka a RStudio může být i nižší. Ale toto je konfigurace, kterou budu používat při prezentaci.
...
required <- c("czso", "dplyr", "ggplot2", "giscoR", "gtools", "gstat", "hereR",
              ...
              "nngeo", "osmdata", "RCzechia", "readr", "remotes",
