...
V první řadě budete potřebovat přiměřeně čerstvé R a RStudio. V ideálním případě R 4.1.2 a RStudio 2021.09.2 - stačit bude jakákoliv čtyřková verze erka a RStudio může být i nižší. Ale toto je konfigurace, kterou budu používat při prezentaci.
...
required = c("czso", "dplyr", "ggplot2", "giscoR", "gtools", "hereR",
             ...
             "nngeo","osmdata", "raster", "rgdal", "RCzechia", "readr", "remotes",
