...
czso::czso_get_table_schema("250169r20")

# tabulka po obcích za rok 2020
nezam_20 <- czso::czso_get_table("250169r20")
...
metrika <- nezam_20 %>% 
   filter(obdobi == "20201031" & vuk == "NEZ0007")
...
ggplot(chrt_src) +
   ...
   labs(title = "Počet uchazečů o práci v obci",
        subtitle = "stav k říjnu 2020")

# mapview - jednoduchý interaktivní
library(mapview)

mapview::mapview(chrt_src)
