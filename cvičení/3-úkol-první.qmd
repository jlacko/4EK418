...
Pamatujte přitom, že německé Bundesländer jsou NUTS úrovně 1, a všechny NUTSy bydlí v balíčku `giscoR`, konkrétně [`giscoR::gisco_get_nuts()`](https://ropengov.github.io/giscoR/reference/gisco_get_nuts.html).
